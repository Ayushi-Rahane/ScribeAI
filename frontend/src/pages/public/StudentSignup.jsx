...
import { FaUser, FaGraduationCap, FaUniversalAccess, FaCog, FaArrowRight, FaArrowLeft } from "react-icons/fa";
...
const StudentSignup = () => {
    ...
    const addSubject = (e) => {
        if (e.key === 'Enter' && subjectInput.trim()) {
            ...
            if (!formData.preferredSubjects.includes(subjectInput.trim())) {
                setFormData({
                    ...formData,
                    preferredSubjects: [...formData.preferredSubjects, subjectInput.trim()]
                });
            }
            setSubjectInput("");
        }
    ...
    const removeSubject = (subject) => {
        setFormData({
            ...formData,
            preferredSubjects: formData.preferredSubjects.filter(s => s !== subject)
        });
    };
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const registrationData = {
                ...
                examFrequency: formData.examFrequency,
            ...
            <div className="max-w-3xl mx-auto">
                ...
                <div className="mb-8">
                    <div className="flex justify-between items-center">
                        {[
                            ...
                            { num: 2, label: "Academic", icon: <FaGraduationCap /> },
                            { num: 3, label: "Accessibility", icon: <FaUniversalAccess /> },
                            { num: 4, label: "Preferences", icon: <FaCog /> },
                        ].map((s, idx) => (
                ...
                <div className="bg-white rounded-2xl shadow-lg p-6 md:p-8">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        {step === 2 && (
                            <div className="space-y-6">
                                <h2 className="text-xl font-semibold text-[#111F35] mb-4">Academic Information</h2>
                                ...
                                <div>
                                    <label className="block text-sm text-gray-600 mb-2">Preferred Subjects</label>
                                    <div className="flex flex-wrap gap-2 mb-2">
                                        {formData.preferredSubjects.map((subject) => (
                                            <span
                                                key={subject}
                                                className="px-3 py-1.5 bg-red-50 text-[#F63049] rounded-lg text-sm border border-red-200 flex items-center gap-2"
                                            >
                                                {subject}
                                                <button type="button" onClick={() => removeSubject(subject)} className="text-red-400 hover:text-red-600">×</button>
                                            </span>
                                        ))}
                                    </div>
                                    <input
                                ...
                                <div>
                                    <label className="block text-sm text-gray-600 mb-2">Additional Academic Notes</label>
                                    <textarea
                                        name="academicNotes"
                        ...
                        {step === 3 && (
                            <div className="space-y-6">
                                <h2 className="text-xl font-semibold text-[#111F35] mb-4">Accessibility Information</h2>
                                ...
                                <div>
                                    <label className="block text-sm text-gray-600 mb-2">Specific Needs / Accommodations Required</label>
                                    <textarea
                                        name="specificNeeds"
                        ...
                        {step === 4 && (
                            <div className="space-y-6">
                                <h2 className="text-xl font-semibold text-[#111F35] mb-4">Communication Preferences</h2>
