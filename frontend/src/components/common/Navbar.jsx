...
const Navbar = () => {
    ...
    const handleNavClick = (e, id) => {
        ...
        // but we might want to handle it differently if it's SPA.
        // For simplicity assuming SPA with sections on Home.
    };
    ...
    return (
        ...
        >
            <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
                ...
                {/* Logo */}
                <Link to="/" onClick={(e) => handleNavClick(e, 'home')} className="flex items-center gap-2 cursor-pointer">
                    <svg
                        className="w-8 h-8"
                        viewBox="0 0 96 96"
                ...
                <div className="flex items-center gap-6">
                    <Link
                        to="/login"
                        className="text-gray-700 font-medium hover:text-[#F63049] transition"
                    >
                        Log in
                    </Link>

                    <button className="bg-[#F63049] text-white px-5 py-2 rounded-lg font-medium hover:bg-[#d9283f] transition">
                        Get Started
                    </button>
                </div>
